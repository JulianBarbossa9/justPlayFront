      ...
      { error && <Error>Fields with <span>*</span> are Required </Error>}
        <form onSubmit={(event) => handleSubmit(event)}>
          <div className='border-b border-gray-900/10 pb-12 mt-10'>
            <h2 className="text-2xl font-bold   leading-7 text-gray-900">{selectedGame ? 'Edit Game' : "Create a Game"}</h2>
              ...
              <div className='sm:col-span-3'>
                ...
                <div className='mt-2'>
                  <textarea 
                    ...
                    id='description-game'
                    className='block w-full px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6'
                  />
                </div>
              </div>
